...
#pip install wordcloud(词云,下载wordcloud-1.3.2-cp36-cp36m-win32.whl安装)
...
coloring=np.array(Image.open("E:\wordcloud.jpg"))
my_wordcloud=WordCloud(background_color="white",max_words=2000,mask=coloring,max_font_size=60,random_state=42,scale=2,font_path="C:/Windows/Fonts/simkai.ttf").generate(word_space_split)
